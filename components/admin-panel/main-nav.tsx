    ...
    return (
        <div className="min-h-screen md:grid md:grid-cols-[240px_minmax(0,1fr)]">
            ...
            >
                ...
                <div
                    className={cn(
                        "relative h-full w-[240px] max-w-full bg-sidebar transition-transform md:translate-x-0",
            ...
            <div className="bg-sidebar md:pt-1.5">
                <div className="relative min-h-full bg-sidebar pt-px md:rounded-tl-2xl md:border md:border-b-0 md:border-r-0 md:border-sidebar-border md:bg-background">
